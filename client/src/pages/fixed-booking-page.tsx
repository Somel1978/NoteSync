...
export default function FixedBookingPage() {
  ...
  // The key styling change is here - no margins or container elements after the form
  return (
    <AppLayout>
        ...
        <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {/* Actions with fixed button bar at the bottom with NO margin after */}
              <div className="flex justify-between bg-background py-6">
                <Button 
                  type="button"
                  variant="outline"
                  onClick={() => form.reset()}
