      ...
      <CardContent className="p-0">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500">{location?.name || `Location ID: ${room.locationId}`}</p>
          </div>
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-700">Flat Rate: {formatCurrency(room.flatRate)}</span>
            </div>
          </div>
          <div>
            <div className="flex items-center">
              <ClockIcon className="h-5 w-5 text-gray-400 mr-2" />
              <span className="text-sm text-gray-700">Hourly Rate: {formatCurrency(room.hourlyRate)}</span>
            </div>
          </div>
        </div>
