                    ...
                    <div className={`p-4 mb-6 rounded-md ${
                      ...
                      <h3 className="font-medium">
                        {t('appointments.detailsModal.status')}: {
                          appointment.status === "approved" ? t('appointments.approved') : 
                          appointment.status === "rejected" ? t('appointments.rejected') : 
                ...
                <TabsContent value="contact" className="p-6">
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h4 className="text-sm font-medium text-gray-900">{t('appointments.detailsModal.contactInformation')}</h4>
                      </div>
                    </div>
                    <Button 
                      variant="outline" 
